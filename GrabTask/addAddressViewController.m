...
@interface addAddressViewController ()<UIActionSheetDelegate,UIAlertViewDelegate>
...
- (void)viewDidLoad {
    ...
    UILabel * AdressTitle = [[UILabel alloc]initWithFrame:CGRectMake(20, 80, 150, 33)];
    AdressTitle.text = @"收货地址";
    AdressTitle.textColor= [UIColor lightGrayColor];
    [self.view addSubview:AdressTitle];
    
    UILabel * AdressTip = [[UILabel alloc]initWithFrame:CGRectMake(0, 382, 414, 60)];
    ...
    saveBtn.backgroundColor = chooseColor;//ps吸一下 改下颜色用COLOR(rgbValue)
    [self.view addSubview:saveBtn];
    
    UIView * inputAdressView = [[UIView alloc]initWithFrame:CGRectMake(0, 117, 414, 250)];
